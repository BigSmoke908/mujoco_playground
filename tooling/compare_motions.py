...
plt.plot(original_motion["original_motion"], label="cmd")
plt.plot(original_motion["recorded_motion"], label="state on bot")
plt.plot(simulated_motion["recorded_motion"], label="state in sim")
plt.legend(ncol=2, fontsize="small")
plt.show()
