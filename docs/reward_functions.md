...
Alle Teil-Rewards werden über konfigurierbare Skalierungsfaktoren gewichtet (siehe `reward_config` in der Joystick.py) und anschließend zeitlich integriert.
