...
from mujoco_playground._src.locomotion.wolves_op_tc import base as wolvesop_base
from mujoco_playground._src.locomotion.wolves_op_tc import wolvesop_constants as consts
...
class Joystick(wolvesop_base.WolvesOPTCEnv):
  ...
  def _reward_tracking_lin_vel(
   ...
   # local_vel = local_vel.at[0].set(-local_vel[0])----------------------------------------------------invertiert Achse
